...
No config files at project root. Everything lives inside the platform's skill directory. No pollution.
...
|----------|------|---------------|
| **OpenCode** | Skill | skill directory |
| **Claude Code** | Skill | skill directory |
| **Trae** | Skill | skill directory |
| **CodeBuddy** | Skill | skill directory |
| **Gemini CLI** | Skill | skill directory |
| **Cursor** | Rule | rule file |
| **Windsurf** | Rule | rule file |
| **GitHub Copilot** | Rule | rule file |
| **Amazon Q** | Rule | rule file |
| **通义灵码** | Rule | rule file |
| **Void** | Rule | rule file |
| **Codex CLI** | Generic | AGENTS.md |
| **Generic** | Generic | AGENTS.md |

> Platform-specific paths are generated by the CLI. See [INSTALL.md](.opencode/INSTALL.md) for details.
...
├── PROJECT_CONSTITUTION.md           # project governance and constraints
├── GOTCHAS.md                        # known AI failure patterns
